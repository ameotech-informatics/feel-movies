    ...
    public class Pager : IHtmlString
    {
        ...
        public virtual string ToHtmlString()
        {
            ...
            else
            {
                ...
                sb.Append("<div class=\"blog-pagenat-wthree\">");
                sb.Append("<ul>");
                ...
                foreach (var paginationLink in model.PaginationLinks)
                {
                    if (paginationLink.Active)
                    {
                        ...
                        {
                            sb.AppendFormat("<li class=\"active\"><span class=\"activepage\">{0}</span></li>", paginationLink.DisplayText);
                        }
                    ...
                    else
                    {
                        ...
                        {
                            sb.AppendFormat("<li><span class=\"disabled activepage\">{0}</span><li>", paginationLink.DisplayText);
                        }
                        else
                        {
                            sb.AppendFormat("<li><span class=\"spacer\">{0}</span></li>", paginationLink.DisplayText);
                        }
                    }
                }
                sb.Append("</ul>");
